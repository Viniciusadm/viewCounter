const key = 'AIzaSyBJ77zlJ443xyt0aF0Opxq0PjIrz4P3jnoA'
...
async function getContent() {
    ...
    for (let id of videosIds) {
        ...
        views = numeroComPontos.reverse().join('')
    ...
    for (video of listaDeVideos) {
        if (contador === 1){
            ...
            <p class="lead"><span class="bordaVisualizacoes">${video.views}</span> visualizações</p>
            </div>`
